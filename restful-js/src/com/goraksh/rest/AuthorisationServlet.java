...
public class AuthorisationServlet extends HttpServlet {
	...
	String redirectUri = appendToRedirectUri(requestParamsMap) ;
		...
		System.out.println("Authorisation Servlet forwarding it to /storageAndRedirection");
		//getServletContext().getRequestDispatcher("/storageAndRedirection").forward(request, response);
		response.getWriter().print(redirectUri);
