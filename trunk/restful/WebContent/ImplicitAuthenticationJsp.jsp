...
<body id="scriptbody" >
	...
	<div align="center" id="endpoint" class="endpoint">
		<br>
		<br> <img src="images/authenticate.jpg"
...
<div align="center" id="form" class="form">
	<form name="authenticate_app" id="authenticate_app"	 action="${pageContext.request.contextPath}/oauthlogin" method="POST" target="_parent" >
		
			<br> <font size="2" face="verdana" color="black"><b>Username/Email:
			</b></font><input type="text" name="user_name" value="nk" ><br> <font size="2"
				face="verdana" color="black"><b>Password: </b></font><input
				type="text" name="password" value="nk"> <br>
				<br>
			<ul>
	...
	<div align="center">
		...
		<br>
		<a target="_blank"
			href="http://restful-fundamentals.blogspot.in/2013/04/oauth-20-introducation.html">See
