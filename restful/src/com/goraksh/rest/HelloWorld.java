...
public class HelloWorld extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println( "var urlStr = " + "\"" + location + "\"" );
		out.println( "//var urlStr = window.location.href;" );
		
		out.println( "var hashIndex = urlStr.indexOf(\"#\", 0 );" );
		out.println( "var originalUrl = urlStr.substring(0,  hashIndex);" );
		
		out.println( "document.write(originalUrl);");
		out.println( "window.location = originalUrl;");
